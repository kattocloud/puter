...
* add --overwrite-config and configurable uuid masking ([ef6671d](https://github.com/kattocloud/puter/commit/ef6671da18f6841cb2143808fe21586ac3505942))
* add -c flag for phoenix ([b6c0cb6](https://github.com/kattocloud/puter/commit/b6c0cb6abc1c29846b4b7e696812476bea24bbc7))
* add chat completions driver to puterai module ([4e3bd18](https://github.com/kattocloud/puter/commit/4e3bd1831e92e83ce9b4e30a16afd562b0221dd8))
* add config for blocked email domains ([955b087](https://github.com/kattocloud/puter/commit/955b087297f829b11b82dc9bd79a0e03721c5f33))
* add connectToInstance method to puter.ui ([62634b0](https://github.com/kattocloud/puter/commit/62634b0afe4d33da08768975322d4deb23041442))
* add feature flag for /share ([461ea3e](https://github.com/kattocloud/puter/commit/461ea3eae6ad32bf34c43a822de7a06f08efb556))
* add image generation driver to puterai module ([fb26fdb](https://github.com/kattocloud/puter/commit/fb26fdbc561d5545d28352427553695cd3237ad5))
* Add Indonesian Translation for i18n ([033643b](https://github.com/kattocloud/puter/commit/033643b0e757b51ea0be90e2198bbec65d31cfc5))
* add message encryption between Puter peers ([cea2964](https://github.com/kattocloud/puter/commit/cea29645fec493020a4f66e378b087fa17ae03d4))
* add method to list models ([fd86934](https://github.com/kattocloud/puter/commit/fd86934bc9021541810447cf7e2a5f33b3e283b3))
* add password reset from server console ([984ae9e](https://github.com/kattocloud/puter/commit/984ae9e6a23da17414e43d58fc0e861827031269))
* add server command to scan permissions ([54471fa](https://github.com/kattocloud/puter/commit/54471fada946a70eaa0df6bfceae995bc4e5848c))
* add streaming to XHR driver client ([7600d9b](https://github.com/kattocloud/puter/commit/7600d9b07c5b719d529f8a48c38d9178efefa266))
* add support for `fadeIn` effect for `UIWindow` ([13248a9](https://github.com/kattocloud/puter/commit/13248a99bfa318e84cb99e2954a5f46805eda34f))
* add system user ([ab15629](https://github.com/kattocloud/puter/commit/ab156297a746c0754145c2abdb2c99bb1b30651a))
* add test_mode flag ([9a9bd5e](https://github.com/kattocloud/puter/commit/9a9bd5eaf0aca8fd1cc57455db03dba55801d5a0))
* add textract driver to puterai module ([f924d48](https://github.com/kattocloud/puter/commit/f924d48b02f39884931db45a05dd61b65f2cee4a))
* add tts driver to puterai module ([78fa77d](https://github.com/kattocloud/puter/commit/78fa77d9200e0b9fafc4014f8d0cb08c74cd16cb))
* add writable attribute to fs items ([2386d87](https://github.com/kattocloud/puter/commit/2386d87229aa6205ef8ced6563371ab40a0def62))
* allow passing cli args via url ([5317adf](https://github.com/kattocloud/puter/commit/5317adf8a4961be3f0ca2a8c403c922633f934fa))
* **api:** add /lsmod ([32f0edb](https://github.com/kattocloud/puter/commit/32f0edb93a8fb0c33b0614b99c7fc439c8f6afc9))
* grant user driver perms from admin ([c9ded89](https://github.com/kattocloud/puter/commit/c9ded89b22bb822c20aea379a17a8bdf74a658de))
* make public folders a config opt-in ([209555c](https://github.com/kattocloud/puter/commit/209555c1d93845fa129bea450f9c25d595a3c60f))
* progress indicator for emulator ([08601ae](https://github.com/kattocloud/puter/commit/08601ae2af7b1f564690e6a9cae7e689cb7ba48a))
* **puterai:** add claude ([d009cd0](https://github.com/kattocloud/puter/commit/d009cd0aaff645a24d37085ed41c55fe296a5722))
* **puterai:** add groq ([53e7a91](https://github.com/kattocloud/puter/commit/53e7a91f1800b60b48575a6e41d96d2ccbd6d362))
* **puterai:** add mistral ([055c628](https://github.com/kattocloud/puter/commit/055c628afd2e33589d3dc66c52934505143eafd4))
* **puterai:** add streaming ([9d5963c](https://github.com/kattocloud/puter/commit/9d5963cdf5fe63a4f7970d2d03bc307f4d4fa3ab))
* **puterai:** add togetherai ([bdfdf23](https://github.com/kattocloud/puter/commit/bdfdf2331b37680b95ac56b31026d3bdab4c173b))
* **puterjs:** add drivers module ([439f52b](https://github.com/kattocloud/puter/commit/439f52b5a3f1a94e6d15ddacc315ae797f4709c2))
* **putility:** trait method override support ([43c5402](https://github.com/kattocloud/puter/commit/43c5402b7cb92e604cbe59badc8f735131d2c349))
* **readme:** add french readme respecting format and styling ([02e7e27](https://github.com/kattocloud/puter/commit/02e7e27796d42e280c21529fe8386a2129761825))
* replace default_user with admin ([f0c36a1](https://github.com/kattocloud/puter/commit/f0c36a1cdf16f11765c29360a5c38140008b90c7))
* report feature flags in /whoami ([4561b89](https://github.com/kattocloud/puter/commit/4561b8937de025471c2dfb1771465d779cefab5d))
* support readdir for directory symlinks ([7f1b870](https://github.com/kattocloud/puter/commit/7f1b870d302421972c4f6221ae6d93b5979d51dd))
* translate README.md to Dutch ([31e2773](https://github.com/kattocloud/puter/commit/31e2773743c336630c917e893b0148441f5fc515))
* v86 9p server support ([b145e30](https://github.com/kattocloud/puter/commit/b145e30a90ff2f0d44d89f83dbda4de1bf2991d4))
* welcome screen to quickly explain what Puter is ([564ff65](https://github.com/kattocloud/puter/commit/564ff65363258cab4196b967dd556105e424d48c))


### Bug Fixes

* 1954f8-related issue ([f5865da](https://github.com/kattocloud/puter/commit/f5865daede2b32682d0472926bc5db65c9ef37ab))
* 1954f8-related issue [#2](https://github.com/kattocloud/puter/issues/2) ([143cfb5](https://github.com/kattocloud/puter/commit/143cfb5654eca8b50fb7ff434f47db24d7bdf3aa))
* add anti-csrf token for /revoke-session ([b6b64d3](https://github.com/kattocloud/puter/commit/b6b64d3bccb6e17240a245c956ead2ae5a87c8dd))
* add context to event listener aiife ([3f07ead](https://github.com/kattocloud/puter/commit/3f07ead1b9940ee133c142f4c34d19884bbb3cd2))
* add env to EmitPlugin config ([4b89101](https://github.com/kattocloud/puter/commit/4b8910169a26f85489135cd84b27fe8f91b37bc6))
* add missing driver parameter to /call endpoint ([b520783](https://github.com/kattocloud/puter/commit/b520783bf4a543c71eaef73277f42d5918ac4469))
* add progress bar fix ([a70d0dd](https://github.com/kattocloud/puter/commit/a70d0dd0881b0a07cea404fe13515a5e10321e3e))
* admin user public folder ([3819584](https://github.com/kattocloud/puter/commit/3819584d119076658c9d4be2b2b941c58d122ad4))
* allow ETX to propagate to bash ([259877b](https://github.com/kattocloud/puter/commit/259877b677a7bfc8e5b377c8852d687978c9bc24))
* app pseudonym in wrong conditional block ([9985996](https://github.com/kattocloud/puter/commit/99859966866ebce005f88e3a916c68dc04ba97bf))
* continue work on blocked_email_domains ([515051d](https://github.com/kattocloud/puter/commit/515051dabf9f2a145ae2d090f829df7188e9fd28))
* creating app shortcut in self-hosted ([38dcb60](https://github.com/kattocloud/puter/commit/38dcb60d3f407dd185999d01d8e14355b47df0b8))
* disable thumbnails for AppData uploads ([37e7b6a](https://github.com/kattocloud/puter/commit/37e7b6ad70f197db3be8712315446079caa23892))
* disable unconfigured ai services ([476acae](https://github.com/kattocloud/puter/commit/476acae0e0d07c7b025cdbcfd86aacfedd7831a5))
* dist ([ed7d6dc](https://github.com/kattocloud/puter/commit/ed7d6dcbfbf432ae90d9e379dbf47de5587a57a2))
* do primary read of user after setting email_confirmed ([ef245b7](https://github.com/kattocloud/puter/commit/ef245b70df482ff470877459fcb28e1f490fe42d))
* **docker:** ensure temp admin pass shows ([d2c7477](https://github.com/kattocloud/puter/commit/d2c7477b3bf170be492a6d5387330645cdf9c33a))
* don't display all apps for extensionless files ([010282e](https://github.com/kattocloud/puter/commit/010282edf299c2a39e53de7441b8850d0b8011b8))
* don't try to sanitize null owners ([cb4cab5](https://github.com/kattocloud/puter/commit/cb4cab529affa5c28ddb32b90328ad47f21de8d4))
* don't var when no var ([5f7d1f5](https://github.com/kattocloud/puter/commit/5f7d1f589a56b3d3ea2026dcbd5f9c48b8dc9e6d))
* double-echo in phoenix ([6bdcae7](https://github.com/kattocloud/puter/commit/6bdcae769d311b5deb82136d5e35d7ad986bca28))
* email change on account with unverified email ([33de981](https://github.com/kattocloud/puter/commit/33de98107f6e3284acb180b1a44bb02ae082642f))
* env for dev build ([46a0f71](https://github.com/kattocloud/puter/commit/46a0f714d10c2fa99ee9436f453176d54cc161f8))
* error deleting entry from My Websites window ([fff8993](https://github.com/kattocloud/puter/commit/fff89932002d67bf0f121532709c871263e33473))
* error in process.handle_connection ([cb324cc](https://github.com/kattocloud/puter/commit/cb324cc125285b5cd6a6b0cebf444a6cd873ded9))
* errors thrown by launch_app ([c22a69f](https://github.com/kattocloud/puter/commit/c22a69ffb1809ad7959f8a8fe934052369b5d44f))
* fallback to read access in /sign ([813ee95](https://github.com/kattocloud/puter/commit/813ee95cee6f1fca79a886b12d8fe4603ca0d213))
* fix 500 when check-app has bad url ([9a62200](https://github.com/kattocloud/puter/commit/9a622004ea488783127abd83f3f4caf779a5aabb))
* fix sourcemap ([cd39bb5](https://github.com/kattocloud/puter/commit/cd39bb5aa073286baa053f8458f0af54a4b7313a))
* height 100% on flexer and step view ([c6bc42f](https://github.com/kattocloud/puter/commit/c6bc42f551a46919b4b70a9ae3dfec85086b0233))
* html-webpack-plugin dev dep ([cc4ab1c](https://github.com/kattocloud/puter/commit/cc4ab1cb36a002929f26a39f252a262fc1f1aab4))
* implicit app permissions bug ([6b4a19e](https://github.com/kattocloud/puter/commit/6b4a19e12a115be2c0e323d17340ab2ce2b6b025))
* issue with service scripts that use TestView ([e0b9072](https://github.com/kattocloud/puter/commit/e0b90721299fa3013f66c866ba637c52efe9df1d))
* ll_write ([a7cdb70](https://github.com/kattocloud/puter/commit/a7cdb70251ae86f883257de3596838d20196c62d))
* missing key for feature flag perm check ([1482048](https://github.com/kattocloud/puter/commit/14820481b9700a5c61c6d9a156944f42f9879008))
* missing method in SLink ([5b74b4a](https://github.com/kattocloud/puter/commit/5b74b4affae5473029e887542717c76c7b32f562))
* mistakes ([3092300](https://github.com/kattocloud/puter/commit/3092300a0144791b25816b39845a3d85968e9059))
* notepad save issue ([bc51d4b](https://github.com/kattocloud/puter/commit/bc51d4bd52b5d0a7bb4feddea7bb9d73e449f7d8))
* only show 2fa when available ([9fa12d4](https://github.com/kattocloud/puter/commit/9fa12d43fc782d7e4d2584b1cf74dca13b7ced25))
* phoenix incorrect lookup order ([c8f913d](https://github.com/kattocloud/puter/commit/c8f913d710454d0ab3da2147309b442a78965720))
* prevent code from breaking just because it was bundled ([fb1216d](https://github.com/kattocloud/puter/commit/fb1216d488bed8ee8d88c7c71e4a6f1054e3a01c))
* prevent large logs from service events (2) ([e514dfc](https://github.com/kattocloud/puter/commit/e514dfcf5049771af3901334e37b1a7c53e05452))
* properly add owner object to fsentries ([04c05a5](https://github.com/kattocloud/puter/commit/04c05a5bb8b73dda21093a2bf563f5cd6faaa356))
* **puterai:** adapt message role for claude ([c08b897](https://github.com/kattocloud/puter/commit/c08b897d4a6a77c54a7e8d2e705e2048ab4797ba))
* **puterai:** close streams ([eb18550](https://github.com/kattocloud/puter/commit/eb18550f411947a0d8ccaf283701596b1386cfe6))
* **puterjs:** fix settings object check ([5a616f6](https://github.com/kattocloud/puter/commit/5a616f67dd22a0dcbb8a380bbbd2347a0029ce31))
* quick patch to avoid columnify error ([4396534](https://github.com/kattocloud/puter/commit/439653458eab38e622cf215ae96b6af34d1db7d4))
* remove accidentally left-over code ([72946f9](https://github.com/kattocloud/puter/commit/72946f920c9f27f4c9de3156aa9144d290699222))
* remove now-redundant loadScript call ([c9d09a7](https://github.com/kattocloud/puter/commit/c9d09a78b6f4bc9682d13d2f982f9a2b7f77dd66))
* remove redundant openai model fallback ([9db55fc](https://github.com/kattocloud/puter/commit/9db55fc5f7a975ab301c88bbac493b7a5b1933bb))
* require confirmed email for public folder ([0519b4a](https://github.com/kattocloud/puter/commit/0519b4a71b236e464c9d1136065e8f5ba15def8e))
* requirement for email_confirmed in backend ([6e325fa](https://github.com/kattocloud/puter/commit/6e325fa000f19b8f20d79829ab2bd78edce80425))
* second half of connectToInstance ([4311b48](https://github.com/kattocloud/puter/commit/4311b482fd629c6d1f65956eb711c8e890453179))
* **security:** always use actor ([1954f86](https://github.com/kattocloud/puter/commit/1954f86680be642e1af03f648d6b587fe67dfaa8))
* **security:** remove unconfirmed_email from /whoami for apps ([a002ad0](https://github.com/kattocloud/puter/commit/a002ad08e5622a349b5d24ed2c7c5f61215146b8))
* **security:** signing in public folders ([937528f](https://github.com/kattocloud/puter/commit/937528f7676e8ace7287141e1f5057842a2b5eb7))
* share services and features with apps ([48fea77](https://github.com/kattocloud/puter/commit/48fea77a20a0938fc2272483c798b817ca1c9848))
* simplify callback listener and fix async bug ([db3e0b5](https://github.com/kattocloud/puter/commit/db3e0b5ce84e4b0b35550f380da97b5d6fcb394b))
* small issue in Service.js ([3c5d2af](https://github.com/kattocloud/puter/commit/3c5d2af8c8341ef78236ef38153ed0b4f20c5cac))
* sqlite condition in MonthlyUsageService ([d4319ea](https://github.com/kattocloud/puter/commit/d4319ea072e0793a32dbddb1d456227cf481e42c))
* sqlite migrations error ([d0e461e](https://github.com/kattocloud/puter/commit/d0e461e206300e7fe3f9bc7f54eaa3a25bb762d8)), closes [#639](https://github.com/kattocloud/puter/issues/639)
* thumbnail service updates ([c2a9506](https://github.com/kattocloud/puter/commit/c2a9506b4855f67d320eb479a67800098d73e8ec))
* turns out we don't support `utm_source` I learn something new about Puter every day! ([99ce3bd](https://github.com/kattocloud/puter/commit/99ce3bde199de729c4796a681c188c4a0da9165e))
* typo in a default file ([aa61c30](https://github.com/kattocloud/puter/commit/aa61c3009c624099e7bd518870b18b02c008530c))
* upsert subdomain check to insert only ([f2acd83](https://github.com/kattocloud/puter/commit/f2acd83b72c388939233fd7145f2dcf78d8ad39e))
* use jq el for focus ([d350264](https://github.com/kattocloud/puter/commit/d35026467eb9a5f67d6ec0c99f2a24d418b8e3a5))
* wait no ([12e0cec](https://github.com/kattocloud/puter/commit/12e0cecf02f4d906035a6f0059557416475db106))
* webpack error reporting + unintentional whitespace changes ([4910838](https://github.com/kattocloud/puter/commit/4910838ab1a72738b44f948cbf65feea848e5271))
